...
public class PrintUtils {
    ...
    public static void printWithColor(String message, String color, String bg) {
        System.out.println(color + bg + message + ConsoleColors.RESET);
    }
    ...
    public static void printInlineWithColor(String message, String color) {
        System.out.print(color + message + ConsoleColors.RESET);
    }

    public static void printInlineWithColor(String message) {
        printInlineWithColor(message, "");
    }
